...
public class SecurityConfig extends WebSecurityConfiguration{
    ...
    SecurityFilterChain filterChain(HttpSecurity http) throws Exception{
        http
                ...
                .requestMatchers(HttpMethod.POST, "/api/producto/create").hasAuthority("ADMIN")
                .requestMatchers(HttpMethod.GET,"/api/index/index").hasAnyAuthority("ADMIN" , "USER")
                ...
                .requestMatchers(HttpMethod.PUT, "/api/producto/edit").hasAuthority("ADMIN")
